...
public class EnemyManager : MonoBehaviour
{
   public static EnemyManager instance;
    ...
    public void EnemyDied(bool cannibal)
    {
        ...
        // öldürülen enemy sayýsýný arttýr
        enemiesKilled++;
    ...
    {
        currentLevel++;
        enemiesKilled = 0; // yeni level için resetle

        // düþman sayýsýný level + initial deðer yap
        cannibal_Enemy_Count = initial_Cannibal_Count + currentLevel;
        boar_Enemy_Count = initial_Boar_Count + currentLevel;

        UpdateLevelUI();

        // yeni düþmanlarý spawnla
        SpawnEnemies();
    }
    void UpdateLevelUI()
    {

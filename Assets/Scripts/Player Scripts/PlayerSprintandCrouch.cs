...
public class PlayerSprintandCrouch : MonoBehaviour
{
    ...
    void Sprint()
    {
        ...
        if(sprint_Value > 0f)
        {
            if (Input.GetKeyDown(KeyCode.LeftShift) && !is_Crouching && isMoving)
            {
    ...
    void Crouch()
    {
        if(Input.GetKeyDown(KeyCode.C))
        {
            ...
            if(is_Crouching)
            {
                //local position dersek parentin posiyonuza, sadece pozisyon dersek Unitynin koordinat sistemine atýf yapar.
